...
> 
```
  git clone https://github.com/nholuongut/magento-2-aws-autoscaling-cluster-with-terraform.git .
```
>  
...
> modules configuration here: https://github.com/nholuongut/Magento-2/blob/main/composer.json  
